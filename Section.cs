...
namespace Cars
{
    public class Section
    {
        ...
        public Section(Tuple<int, int> LeftA, Tuple<int, int> RightA, Tuple<int, int, double> LeftW = null, Tuple<int, int, double> RightW = null, Tuple<int, int> EndA = null, int? Width = null, List<WeaponSlot> Weapons = null)
        {
